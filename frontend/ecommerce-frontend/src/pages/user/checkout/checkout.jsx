            ...
            <Col className='py-4 bg-light'>
                <Row className='align-items-center justify-content-between px-3'>
                    <Col className='col-12 text-start'>
                        <small>Ivan Richardo | (+62) 85770205983</small>
                        <hr/>
                    </Col>
                </Row>
                <Row className='align-items-center justify-content-between px-3'>
                    <Col className='col-10 text-start'>
                        <small className='m-0'>Vanya Park Azura House, Jalan Bsd Raya, Cicalengka, Pagedangan (Blok C8 no. 16), KAB. TANGERANG - PAGEDANGAN, BANTEN, ID 15330</small>
                    </Col>
                    <Col className='col-2 text-center'>
                        <Button><small className='m-0'>Edit</small></Button>
                    </Col>
                </Row>
            </Col>
            <Col className='py-4 bg-light' >
